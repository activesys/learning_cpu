...
_start:
    ...
    addl $0x08, %edi
    movl $TEST_DATA_DPL0_BASE, %eax
    movl $TEST_DATA_DPL0_LIMIT, %ecx
    movl $TEST_DATA_DPL0_ATTR, %esi
    call _setup_gdt

    addl $0x08, %edi
    movl $TEST_DATA_DPL3_BASE, %eax
    movl $TEST_DATA_DPL3_LIMIT, %ecx
    movl $TEST_DATA_DPL3_ATTR, %esi
    call _setup_gdt
