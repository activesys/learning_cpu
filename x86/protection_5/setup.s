...
_start:
    ...
    addl $0x08, %edi
    movl $TEST_CODE_DPL0_DATA_BASE, %eax
    movl $TEST_CODE_DPL0_DATA_LIMIT, %ecx
    movl $TEST_CODE_DPL0_DATA_ATTR, %esi
    call _setup_gdt

    addl $0x08, %edi
    movl $TEST_CODE_DPL0_STACK_BASE, %eax
    movl $TEST_CODE_DPL0_STACK_LIMIT, %ecx
    movl $TEST_CODE_DPL0_STACK_ATTR, %esi
    call _setup_gdt

    addl $0x08, %edi
    movl $TEST_CODE_DPL0_VIDEO_BASE, %eax
    movl $TEST_CODE_DPL0_VIDEO_LIMIT, %ecx
    movl $TEST_CODE_DPL0_VIDEO_ATTR, %esi
    call _setup_gdt

    addl $0x08, %edi
    movl $TEST_CODE_DPL3_DATA_BASE, %eax
    movl $TEST_CODE_DPL3_DATA_LIMIT, %ecx
    movl $TEST_CODE_DPL3_DATA_ATTR, %esi
    call _setup_gdt

    addl $0x08, %edi
    movl $TEST_CODE_DPL3_STACK_BASE, %eax
    movl $TEST_CODE_DPL3_STACK_LIMIT, %ecx
    movl $TEST_CODE_DPL3_STACK_ATTR, %esi
    call _setup_gdt

    addl $0x08, %edi
    movl $TEST_CODE_DPL3_VIDEO_BASE, %eax
    movl $TEST_CODE_DPL3_VIDEO_LIMIT, %ecx
    movl $TEST_CODE_DPL3_VIDEO_ATTR, %esi
    call _setup_gdt

    addl $0x08, %edi
    movl $NONCONFORMING_CODE_DPL0_BASE, %eax
    movl $NONCONFORMING_CODE_DPL0_LIMIT, %ecx
    movl $NONCONFORMING_CODE_DPL0_ATTR, %esi
    call _setup_gdt

    addl $0x08, %edi
    movl $NONCONFORMING_CODE_DPL3_BASE, %eax
    movl $NONCONFORMING_CODE_DPL3_LIMIT, %ecx
    movl $NONCONFORMING_CODE_DPL3_ATTR, %esi
    call _setup_gdt

    addl $0x08, %edi
    movl $CONFORMING_CODE_DPL0_BASE, %eax
    movl $CONFORMING_CODE_DPL0_LIMIT, %ecx
    movl $CONFORMING_CODE_DPL0_ATTR, %esi
    call _setup_gdt

    addl $0x08, %edi
    movl $CONFORMING_CODE_DPL3_BASE, %eax
    movl $CONFORMING_CODE_DPL3_LIMIT, %ecx
    movl $CONFORMING_CODE_DPL3_ATTR, %esi
    call _setup_gdt

    addl $0x08, %edi
    movl $CONFORMING_CODE_DPL0_CPL3_BASE, %eax
    movl $CONFORMING_CODE_DPL0_CPL3_LIMIT, %ecx
    movl $CONFORMING_CODE_DPL0_CPL3_ATTR, %esi
    call _setup_gdt

    addl $0x08, %edi
    movl $NONCONFORMING_CALL_GATE_BASE, %eax
    movl $NONCONFORMING_CALL_GATE_LIMIT, %ecx
    movl $NONCONFORMING_CALL_GATE_ATTR, %esi
    call _setup_gdt
